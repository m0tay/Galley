...
struct SyntaxHighlighter {
    ...
    private let builtins = [
        ...
        "text", "emph", "strong", "underline", "overline", "highlight",
        "smallcaps", "super", "sub", "strike", "raw", "linebreak",
        "lorem", "lower", "upper", "smartquote", "link", "footnote",
        // Document structure
        "heading", "figure", "caption", "outline", "bibliography",
        "cite", "ref", "label", "list", "enum", "table", "quote",
        "par", "parbreak", "document", "terms",
        // Layout
        "align", "block", "box", "colbreak", "columns", "h", "v",
        "hide", "layout", "measure", "move", "pad", "page",
        "pagebreak", "place", "repeat", "rotate", "scale", "skew", "stack",
        // Graphics
        "image", "circle", "ellipse", "rect", "line", "polygon",
        "square", "path", "curve", "gradient", "stroke", "color",
        // Math
        "equation", "frac", "vec", "mat", "binom", "cases",
        "accent", "attach", "cancel", "lr", "op",
        // Grid & table helpers
        "grid", "numbering",
        // Introspection & state
        "counter", "state", "locate", "here", "query", "metadata",
        // Data loading
        "json", "yaml", "toml", "csv", "xml", "cbor", "read",
        // Foundations
        "array", "str", "int", "float", "bool", "bytes", "regex",
        "repr", "type", "eval", "panic", "assert", "datetime",
        "duration", "symbol", "selector",
        // Symbols
        "emoji", "sym"
    ]
